...
class DataReader():
    ...
    def read_images(self):
        data = []
        print("Reading Data...")
        classes = os.listdir("dataaz")
        for i, cls in enumerate(classes):
            print("Opening " + cls + "/")
            for el in os.listdir("dataaz/" + cls):
                img = Image.open("dataaz/" + cls + "/" + el)
...
def draw_graph(history):
    ...
    fig.savefig("az_train_history.png")
    ...
    plt.plot(train_history, "red")
    plt.plot(validation_history, 'blue')
    fig.savefig("az_accuracy_history.png")
